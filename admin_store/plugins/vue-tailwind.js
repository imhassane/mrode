...
const settings = {
  't-input': {
    component: TInput,
    props: {
      fixedClasses: 'block w-full px-3 py-1 transition duration-100 ease-in-out border rounded shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed',
  ...
  't-datepicker': {
    ...
    props: {
      fixedClasses: {
        ...
        input: 'block w-full px-3 py-1 transition duration-100 ease-in-out border rounded shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed',
  ...
  't-tag': {
    component: TTag,
    props: {
      fixedClasses: 'text-xs px-2 py-1 rounded border',
      classes: '',
      variants: {
        ...
        successOutline: 'text-green-500 border-green-500',
  ...
  't-table': {
    ...
    props: {
      classes: {
        table: 'min-w-full divide-y divide-green-100 border',
        thead: '',
        theadTr: '',
        theadTh: 'px-3 py-2 font-semibold text-left bg-green-500 border-b text-white',
