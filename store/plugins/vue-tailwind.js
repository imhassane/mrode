...
const settings = {
  't-input': {
    component: TInput,
    props: {
      fixedClasses: 'block w-full px-3 py-2 transition duration-100 ease-in-out border rounded focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed',
  ...
  't-button': {
    ...
    props: {
      ...
      variants: {
        ...
        black: 'text-white bg-black border border-black rounded shadow-sm hover:bg-green-500 hover:border-green-500',
        fullBlack: 'w-full text-white bg-black border border-black rounded shadow-sm hover:bg-green-500 hover:border-green-500',
